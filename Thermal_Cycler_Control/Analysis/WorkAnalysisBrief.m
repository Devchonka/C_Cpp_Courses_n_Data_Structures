...
axis([0 max(time57) 90 max(block57)+0.5])
...
AveP57= [mean(P1a57) mean(P1b57) ;
         mean(P2a57) mean(P2b57) ;
         mean(P3a57) mean(P3b57) ;
         mean(P4a57) mean(P4b57) ;
         mean(P5a57) mean(P5b57) ];
...
legend ('Filled P95 Trial 1', 'Filled P95 Trial 2',0)
    grid on
datacursormode()
